                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-2">
                            <a href="https://www.instagram.com/college_pe_charcha/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300">
